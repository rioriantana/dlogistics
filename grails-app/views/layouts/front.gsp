...
<head>
    ...
    <!-- SITE TITLE -->
    <title>KreFolio - Startup Agency Landing Page Template</title>
    ...
    ============================== -->
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'bootstrap.css')}">
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'animate.min.css')}">

    <!-- =========================
       Fonts, typography and icons
    ============================== -->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,600' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'font-awesome.css')}">
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'typography.css')}">

    <!-- =========================
       Carousel, lightbox and circle generator
    ============================== -->
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'owl.carousel.css')}">
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'owl.theme.css')}">
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'nivo-lightbox.css')}">
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'nivo-lightbox-default.css')}">
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'jquery.circliful.css')}">

    <!-- ***** Custom Stylesheet ***** -->
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'main-blue.css')}">

    <!-- ***** Responsive fixes ***** -->
    <link rel="stylesheet" href="${resource(dir: 'front/css', file: 'responsive.css')}">

    <!-- Header scripts -->
    <script src="${resource(dir: 'front/js', file: 'vendor/modernizr-2.8.3.min.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'queryloader2.min.js')}"></script>
...
<body>
        ...
        <div id="myCarousel" class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="logo-container">
                    <a href="#">
                        <img src="${resource(dir: 'front/img', file: 'logo-header.png')}" height="37" width="197" alt="">
                    </a>
                </div>
                ...
                <div class="item active">
                    ...
                    <div class="fill" style="background-image:url('${resource(dir: 'front/img', file: 'slider/slider-4.jpg')}');">
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="fill" style="background-image:url('${resource(dir: 'front/img', file: 'slider/slider-1.jpg')}');"></div>
                    <div class="carousel-caption">
                        <h1 class="light mab-none">This is <strong class="bold-text">KreFolio</strong></h1>
                        <h1 class="light margin-bottom-medium mat-none">And We Are <strong class="bold-text">Awesome</strong></h1>
                        <p class="light margin-bottom-medium">Stop blending in & start leaving your mark on the web.</p>
                ...
                <div class="item">
                    ...
                    <div class="fill" style="background-image:url('${resource(dir: 'front/img', file: 'slider/slider-2.jpg')}');"></div>
                    <div class="carousel-caption">
                        <h1 class="light mab-none">This is <strong class="bold-text">KreFolio</strong></h1>
                        <h1 class="light margin-bottom-medium mat-none">And We Are <strong class="bold-text">Awesome</strong></h1>
                        <p class="light margin-bottom-medium">Stop blending in & start leaving your mark on the web.</p>
                ...
                <div class="item">
                    ...
                    <!-- Set the third background image using inline CSS below. -->
                    <div class="fill" style="background-image:url('${resource(dir: 'front/img', file: 'slider/slider-3.jpg')}');"></div>
                    <div class="carousel-caption">
                        <h1 class="light mab-none">This is <strong class="bold-text">KreFolio</strong></h1>
                        <h1 class="light margin-bottom-medium mat-none">And We Are <strong class="bold-text">Awesome</strong></h1>
                        <p class="light margin-bottom-medium">Stop blending in & start leaving your mark on the web.</p>
                ...
                <div class="item">
                    ...
                    <!-- Set the third background image using inline CSS below. -->
                    <div class="fill" style="background-image:url('${resource(dir: 'front/img', file: 'slider/slider-4.jpg')}');"></div>
                    <div class="carousel-caption">
                        <h1 class="light mab-none">This is <strong class="bold-text">KreFolio</strong></h1>
                        <h1 class="light margin-bottom-medium mat-none">And We Are <strong class="bold-text">Awesome</strong></h1>
                        <p class="light margin-bottom-medium">Stop blending in & start leaving your mark on the web.</p>
        ...
        <div class="overlay">
            <div class="container padding-top-large">
                ...
                <div class="row margin-bottom-medium">
                    ...
                    <div class="col-md-5">
                        <img src="${resource(dir: 'front/img', file: 'about-side-side.png')}" alt="About Us Big Image" class="center-block img-responsive">
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="row margin-top-large">
                    ...
                    <div class="col-md-4">
                        <img src="${resource(dir: 'front/img', file: 'case-studdy-people.png')}" class="center-block img-responsive" alt="Case Study">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="our-skills" class="our-skills">
        <div class="container padding-top-large">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <img src="${resource(dir: 'front/img', file: 'skill-bg.jpg')}" class="center-block img-responsive" alt="Our Skills are excellent">
                </div>
                <div class="clearfix"></div>
            </div> <!-- *** end row *** -->
        </div> <!-- *** end container *** -->
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom-large">
                    ...
                    <div class="team-member center-block wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="1s">
                        <img src="${resource(dir: 'front/img', file: 'team/team-member-1.jpg')}" class="img-responsive" alt="Jack Smith">
                                ...
                                <div class="modal-body member-info">
                                    <div class="row">
                                        <div class="col-md-5 col-sm-5">
                                            <figure>
                                                <img src="${resource(dir: 'front/img', file: 'team/big/team-member-1.jpg')}" alt="Jack Smith">
                                            </figure>
                                        </div>
                                        <div class="col-md-7 col-sm-7">
                                            <div class="description">
                                                ...
                                                <div class="member-skills">
                                                    <div id="skill-1" class="member-skill" data-dimension="100" data-text="PHP" data-width="10" data-fontsize="16" data-percent="35" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                    <div id="skill-2" class="member-skill" data-dimension="100" data-text="Python" data-width="10" data-fontsize="16" data-percent="70" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                    <div id="skill-3" class="member-skill" data-dimension="100" data-text="Laravel" data-width="10" data-fontsize="16" data-percent="80" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                    <div id="skill-4" class="member-skill" data-dimension="100" data-text="WP" data-width="10" data-fontsize="16" data-percent="60" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                </div>
                                            </div> <!-- *** end description *** -->
                                        </div> <!-- *** end col-md-7 *** -->
                                    </div> <!-- *** end row *** -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom-large">
                    ...
                    <div class="team-member center-block wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">
                        <img src="${resource(dir: 'front/img', file: 'team/team-member-2.jpg')}" class="img-responsive" alt="John Doe">
                        <div class="team-overlay text-center">
                            <div class="info">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body member-info">
                                    <div class="row">
                                        <div class="col-md-5 col-sm-5">
                                            <figure>
                                                <img src="${resource(dir: 'front/img', file: 'team/big/team-member-2.jpg')}" alt="John Doe">
                                            </figure>
                                        </div>
                                        <div class="col-md-7 col-sm-7">
                                            <div class="description">
                                                ...
                                                <div class="member-skills">
                                                    <div id="skill-5" class="member-skill" data-dimension="100" data-text="Django" data-width="10" data-fontsize="16" data-percent="35" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                    <div id="skill-6" class="member-skill" data-dimension="100" data-text="Laravel" data-width="10" data-fontsize="16" data-percent="70" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                    <div id="skill-7" class="member-skill" data-dimension="100" data-text="NodeJS" data-width="10" data-fontsize="16" data-percent="80" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                    <div id="skill-8" class="member-skill" data-dimension="100" data-text="WP" data-width="10" data-fontsize="16" data-percent="60" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                </div>
                                            </div> <!-- *** end description *** -->
                                        </div> <!-- *** end col-md-7 *** -->
                                    </div> <!-- *** end row *** -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom-large">
                    <!-- ***** Team member-1 ***** -->
                    <div class="team-member center-block wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">
                        <img src="${resource(dir: 'front/img', file: 'team/team-member-3.jpg')}" class="img-responsive" alt="Jack Sparrow">
                        <div class="team-overlay text-center">
                            <div class="info">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body member-info">
                                    <div class="row">
                                        <div class="col-md-5 col-sm-5">
                                            <figure>
                                                <img src="${resource(dir: 'front/img', file: 'team/big/team-member-3.jpg')}" alt="">
                                            </figure>
                                        </div>
                                        <div class="col-md-7 col-sm-7">
                                            <div class="description">
                                                ...
                                                <div class="member-skills">
                                                    <div id="skill-9" class="member-skill" data-dimension="100" data-text="HTML" data-width="10" data-fontsize="13" data-percent="35" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                    <div id="skill-10" class="member-skill" data-dimension="100" data-text="CSS" data-width="10" data-fontsize="13" data-percent="70" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                    <div id="skill-11" class="member-skill" data-dimension="100" data-text="jQuery" data-width="10" data-fontsize="13" data-percent="80" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                    <div id="skill-12" class="member-skill" data-dimension="100" data-text="AngularJS" data-width="10" data-fontsize="13" data-percent="60" data-fgcolor="#3498db" data-bgcolor="#eee"></div>
                                                </div>
                                            </div> <!-- *** end description *** -->
                                        </div> <!-- *** end col-md-7 *** -->
                                    </div> <!-- *** end row *** -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 margin-bottom-large">
                    ...
                    <div class="team-member center-block wow fadeInRight" data-wow-duration="1.5s" data-wow-delay="1s">
                        <img src="${resource(dir: 'front/img', file: 'team/team-member-4.jpg')}" class="img-responsive" alt="George Wyne">
                        <div class="team-overlay text-center">
                            <div class="info">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body member-info">
                                    <div class="row">
                                        <div class="col-md-5 col-sm-5">
                                            <figure>
                                                <img src="${resource(dir: 'front/img', file: 'team/big/team-member-4.jpg')}" alt="">
                                            </figure>
                                        </div>
                                        <div class="col-md-7 col-sm-7">
                                            <div class="description">
                    ...
                    <div id="testimonial-carousel" class="owl-carousel owl-theme testimonial-carousel">
                        ...
                        <div class="item margin-bottom-small"> <!-- ITEM START -->
                            ...
                            <div class="client margin-top-medium clearfix">
                                <img src="${resource(dir: 'front/img', file: 'testimonial/testimonial-1.jpg')}" height="50" width="50" alt="Client Image">
                        ...
                        <div class="item"> <!-- ITEM START -->
                            ...
                            <div class="client margin-top-medium">
                                <img src="${resource(dir: 'front/img', file: 'testimonial/testimonial-2.jpg')}" alt="Client Image" class="grayscale">
                                <ul class="client-info main-color">
                                    <li>John Doe</li>
                                    <li>Co-Founder, Envato</li>
                                </ul>
                        ...
                        <div class="item"> <!-- ITEM START -->
                            <p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit..</p>
                            <div class="client margin-top-medium">
                                <img src="${resource(dir: 'front/img', file: 'testimonial/testimonial-1.jpg')}" alt="Client Image" class="grayscale">
                                <ul class="client-info main-color">
                                    <li>John Doe</li>
                                    <li>Co-Founder, Envato</li>
                                </ul>
    ...
    <section id="portfolio" class="portfolio padding-large text-center">
        ...
        <div class="portfolio-wrapper margin-bottom-medium">
            ...
            <div class="portfolio-item print">
                <div class="portfolio">
                    <a href="${resource(dir: 'front/img', file: 'portfolio/portfolio-1.jpg')}" data-lightbox-gallery="portfolio">
                        <img src="${resource(dir: 'front/img', file: 'portfolio/portfolio-1.jpg')}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
            ...
            <div class="portfolio-item photography">
               <div class="portfolio">
                  <a href="${resource(dir: 'front/img', file: 'portfolio/portfolio-2.jpg')}" data-lightbox-gallery="portfolio">
                    <img src="${resource(dir: 'front/img', file: 'portfolio/portfolio-2.jpg')}" alt="Portfolio 2"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Cute
            ...
            <div class="portfolio-item photography">
               <div class="portfolio">
                  <a href="${resource(dir: 'front/img', file: 'portfolio/portfolio-3.jpg')}" data-lightbox-gallery="portfolio">
                    <img src="${resource(dir: 'front/img', file: 'portfolio/portfolio-3.jpg')}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="portfolio-item print">
               <div class="portfolio">
                  <a href="${resource(dir: 'front/img', file: 'portfolio/portfolio-4.jpg')}" data-lightbox-gallery="portfolio">
                    <img src="${resource(dir: 'front/img', file: 'portfolio/portfolio-4.jpg')}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="portfolio-item ui">
               <div class="portfolio">
                  <a href="${resource(dir: 'front/img', file: 'portfolio/portfolio-5.jpg')}" data-lightbox-gallery="portfolio">
                    <img src="${resource(dir: 'front/img', file: 'portfolio/portfolio-5.jpg')}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="portfolio-item web-design">
               <div class="portfolio">
                  <a href="${resource(dir: 'front/img', file: 'portfolio/portfolio-6.jpg')}" data-lightbox-gallery="portfolio">
                    <img src="${resource(dir: 'front/img', file: 'portfolio/portfolio-6.jpg')}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="portfolio-item web-design">
               <div class="portfolio">
                  <a href="${resource(dir: 'front/img', file: 'portfolio/portfolio-7.jpg')}" data-lightbox-gallery="portfolio">
                    <img src="${resource(dir: 'front/img', file: 'portfolio/portfolio-7.jpg')}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="portfolio-item icon">
               <div class="portfolio">
                  <a href="${resource(dir: 'front/img', file: 'portfolio/portfolio-8.jpg')}" data-lightbox-gallery="portfolio">
                    <img src="${resource(dir: 'front/img', file: 'portfolio/portfolio-8.jpg')}" alt="Portfolio 1"/><!-- END PORTFOLIO IMAGE -->
                    <div class="portfolio-overlay hvr-rectangle-out">
                        <h2 class="margin-bottom-small">
                            Our
                            <strong class="white-color bold-text">Portfolios</strong>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <figure class="margin-bottom-medium">
                        <img src="${resource(dir: 'front/img', file: 'logo.png')}" class="footer-logo" alt="Krefolio">
                    </figure>
                    ...
                    <p class="copyright">
                        &copy; Copyright 2015 KreFolio - All Rights reserved
                    </p>
                </div>
            </div>
        </div>
    ...
    <!-- =========================
     JavaScripts
    ============================== -->
    <script src="${resource(dir: 'front/js', file: 'vendor/jquery-1.11.1.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'vendor/jquery-migrate-1.2.1.min')}.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyASm3CwaK9qtcZEWYa-iQwHaGi3gcosAJc&amp;sensor=false"></script>
    <script src="${resource(dir: 'front/js', file: 'twitterFetcher_min.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'vendor/bootstrap.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'wow.min.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'imagesloaded.pkgd.min.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'jquery.easing.min.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'appear.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'jquery.circliful.min.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'owl.carousel.min.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'nivo-lightbox.min.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'isotope.pkgd.min.js')}"></script>
    <script src="${resource(dir: 'front/js', file: 'main.js')}"></script>
</body>
</html>
